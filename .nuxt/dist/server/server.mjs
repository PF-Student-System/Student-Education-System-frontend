import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, shallowReactive, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, computed, ref, Suspense, nextTick, mergeProps, Transition, provide, watch, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/dashboard-2TIKR_D0.js").then((m) => m.default || m),
    children: [
      {
        name: "dashboard-exam",
        path: "exam",
        ...
        component: () => import("./_nuxt/exam-BhuXHmyu.js").then((m) => m.default || m)
      },
      {
        name: "dashboard",
        path: "",
        ...
        component: () => import("./_nuxt/index-B7QelBBD.js").then((m) => m.default || m)
      },
      {
        ...
        component: () => import("./_nuxt/teacher-CjGlm6Mi.js").then((m) => m.default || m)
      }
    ]
  },
  {
    ...
    component: () => import("./_nuxt/index-JJqRY2jJ.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index-D9-EsJvj.js").then((m) => m.default || m)
  },
  {
    name: "lectureMod",
    path: "/lectureMod",
    ...
    component: () => import("./_nuxt/lectureMod-tuJpfP-y.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-CxGleYHu.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-R0iNHqHl.js").then((r) => r.default || r));
