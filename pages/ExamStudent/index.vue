<template>
    <div class="border-2 border-customgreen rounded-md mx-10 flex justify-between items-center px-5">
        ...
        <p class="text-customgraytext text-xl" :style="`color : ${textColor}`" v-show="time">Time remaining: {{ displayTime }}</p>
        <p class="text-customgraytext text-xl" :style="`color : ${textColor}`" v-show="timeUp">Times Up!!</p>
    </div>
